...
class CountryItem extends Component {
    render() {
        return (
            <div className="card" style={{width: "100%", height:"10em"}}>
                <img className="card-img-top" style={{width: "100%", height:"10em"}} src={this.props.country.flag} alt={this.props.country.country} />
