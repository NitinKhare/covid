  ...
  return (
    <div className="App">
      ...
      <div className="container">
        ...
        <h3>Data for : <span className="text-success">{this.state.countries.length}</span> {this.state.countries.length > 1 ? "countries" : {this.state.countries[0] === undefined ? 0 : c}} </h3>
        <br />
